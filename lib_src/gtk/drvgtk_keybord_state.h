...
extern struct DrvGtkKeybordState* new_transform_table_DrvGtkKeybordState(guint32 language);

extern void add_DrvGtkKeybordState(
...
extern void next_DrvGtkKeybordState(
	struct DrvGtkKeybordState* press,
	struct DrvGtkKeybordState* release
);
